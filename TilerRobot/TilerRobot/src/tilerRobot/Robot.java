...
public class Robot {
	...
	public static void main(String[] args) {
		...
		printMenuProcessRequest(floorWidth, floorLength, currentFloor,
				myInputScanner);
	}
	...
	private static void printMenuProcessRequest(int floorWidth,
			int floorLength, Floor currentFloor, Scanner myInputScanner) {
		int[] columnTileCount;
		int[] rowTileCount;
		int choise;
		while (true) {
			...
			if ((choise > 0) && (choise < 9)) {
				...
				case 1:
					...
					System.out
							.println("Please enter 1 for black and 0 for white:");
				...
				case 6:
					System.out
							.println("Please enter rectangle coordiantes below:");
					...
					System.out.println("tried fitting" + x4 + "x" + y4 + "@"
							+ x3 + "," + y3 + " coords: "
